...
export const getOrganizationData = () => {
  try {
    const raw = localStorage.getItem("staffle");
...
export const getLocalStorage = () => {
  try {
    ...
    console.error("Invalid staffle data", err);
    return {
      organization: null,
      admin: null,
      employees: []
...
export const setLocalStorage = (data) => {
  if (!data || typeof data !== "object") {
    console.warn("Invalid staffle data, not saving:", data);
    return;
  }
  localStorage.setItem("staffle", JSON.stringify(data));
};
