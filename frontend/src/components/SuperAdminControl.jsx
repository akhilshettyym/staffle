        ...
        <div className="mt-6">
            <div className="bg-[#626F47]/35 backdrop-blur-sm rounded-2xl px-4 py-3 shadow-md">
                {/* <div className="flex flex-wrap items-center gap-3">
                    <h1 className="ml-1 mr-1 text-[#FFDAB3] text-sm uppercase font-semibold"> Super Admin Dashboard </h1>
                    {navItems.map((item) => {
                ...
                <button onClick={() => navigate("/login")} className="bg-[#FFDAB3] text-[#1B211A] font-bold px-10 py-3 rounded-full hover:brightness-110 active:scale-95 transition-all uppercase tracking-widest"> APPROVE ORGANIZATION
          </button>
            </div>
        </div>
    );
